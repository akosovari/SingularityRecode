...
public class DataManager {
    ...
    public PlayerData getDataPlayer(org.bukkit.entity.Player player) { return dataSet.stream().filter(dataPlayer -> dataPlayer.player == player).findFirst().orElse(null); }
